// function searchCollegeList() {
//     var input, filter, list, option, collegeIndex, txtValue;
//     input = document.getElementById("searchInput");
//     filter = input.value.toUpperCase();
//     list = document.getElementById("schoolSearch");
//     option = list.getElementsByTagName("option");
//     for (collegeIndex = 0; collegeIndex < option.length; collegeIndex++) {
//         college = option[collegeIndex];
//         txtValue = college.textContent || college.innerText;
//         if (txtValue.toUpperCase().indexOf(filter) > -1) {
//             option[collegeIndex].style.display = "";
//         } else {
//             option[collegeIndex].style.display = "none";
//         }
//     }
// }

// function loadSearchCollege() {
//     const url = "/static/us_institutions.json";
//     fetch(url, {
//         method: 'GET'
//     }).then(response => response.json()).then((collegeDataList) => {
//         const searchBody = document.getElementById("schoolSearch");
//         const defaultVal = document.createElement('option');
//         defaultVal.innerText = "Select Your College";
//         defaultVal.selected = true;
//         defaultVal.disabled = true;
//         searchBody.append(defaultVal);
//         collegeDataList.forEach((college) => {
//         searchBody.appendChild(createSearchCollege(college));
//         });
//     });
// }

// function createSearchCollege(college) {
//     const collegeElement = document.createElement('option');
//     collegeElement.value = college.name;
//     collegeElement.innerText = college.name;
